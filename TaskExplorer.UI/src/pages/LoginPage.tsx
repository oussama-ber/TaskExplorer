...
import { Zap, Mail, Lock, ArrowRight, AlertCircle, RefreshCw } from 'lucide-react';
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-center justify-between text-xs">
                            <label className="flex items-center gap-2 text-gray-400 cursor-pointer hover:text-gray-300">
                                <input type="checkbox" className="rounded border-gray-600 bg-[#0d1117]/50 text-blue-500 focus:ring-offset-0 focus:ring-blue-500/20" />
                                Remember me
                            </label>
